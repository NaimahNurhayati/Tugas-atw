...
<body class="cnt-home">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 sign-in">
            ...
            <form class="register-form outer-top-xs" role="form">
              ...
              <button type="submit" class="btn-upper btn btn-primary checkout-page-button"><a href="{{url('/template')}}">Login</a></button>
            </form>
          </div>
          <!-- Sign-in -->
  ...
  <script type="text/javascript" src="{{url('public')}}/assets/js/lightbox.min.js"></script>
